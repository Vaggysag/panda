...
char radar_VIN[] = "                 "; // leave empty
uint8_t tesla_radar_can = 0; // 0, 1 or 2 set from EON via fake message
...
int radarPosition = 0; // set from EON via fake message
int radarEpasType = 0; // set from EON via fake message
